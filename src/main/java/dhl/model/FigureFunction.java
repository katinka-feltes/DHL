...
public class FigureFunction {
     ...
     */
    public static int getFigureAmountOnField(int fieldIndex, List<dhl.model.Figure> figures) {
        int amount = 0;
        for (dhl.model.Figure f : figures) {
     ...
     */
    public static int getFigureAmountInFinishArea(List<dhl.model.Figure> figures){
        int amount = 0;
     ...
     */
    public static dhl.model.Figure getFigureByPos(int figurePos, List<dhl.model.Figure> figures) {
        figures.sort(Comparator.comparing(dhl.model.Figure::getPos));
